...
# Description: 11.1(매매) + 11.2(전월세) 테이블의 단지 주소를 카카오 주소 검색 API로 좌표화한다.
#                - 구 이름은 각 행의 gu 컬럼에서 가져온다
#                - 단지 모집단은 매매 단지 + 전세 단지의 합집합이다
#                  (월세만 거래된 단지는 매매·전세 가격 정보가 없어 제외한다)
#                - 수천 건 규모라 중간에 끊기면 손실이 크므로 캐시를 주기적으로 저장한다
#                - 결과 14.1은 19(건축물대장 수집)의 입력이다
#
#              통과 기준: 지오코딩 성공률 >= 95%
# ============================================================================
