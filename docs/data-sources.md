...
| 산출물 | `output/52.1.seoul_bjd_boundary.geojson`(서울 467개 법정동, 3.8MB), `output/52.2.dong_boundary_match.txt`(지수 346개 동 중 340개 매칭, 6개는 §1 품질 이슈), `front/public/data/dong-boundary.geojson`(53이 지수 동 340개만 줄여서 내보낸 프론트 지도용 파일, 결정 42) |
