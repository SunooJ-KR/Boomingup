...
function DongListItem({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={cn(
        "w-full rounded-lg border bg-card p-3 text-left shadow-panel transition-transform duration-150 ease-[var(--ease-out-soft)] hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
    ...
    >
      ...
      <div className="mt-2 flex items-baseline justify-between gap-2">
        ...
        <p className="text-xs text-muted-foreground">최근 1년 매매 {dong.n_sales_4q}건</p>
      </div>
